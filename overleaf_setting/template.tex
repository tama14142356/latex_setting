...
\renewcommand{\subsectionmark}[1]{\markboth{\thesubsection\ #1}{\rightmark}}%   %\leftmarkにサブセクション名を格納
...
\lfoot{テンプレート}%       %左側フッターの定義[<偶数ページ>]{<奇数ページ>}
\cfoot{\thepage}%                    %中央フッターの定義[<偶数ページ>]{<奇数ページ>}
\rfoot{所属}%                  %右側フッターの定義[<偶数ページ>]{<奇数ページ>}
